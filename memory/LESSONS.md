...
- 2026-04-15: On content-driven Astro pages, if the user wants to delete a heading or intro sentence but keep the surrounding layout, make the corresponding content fields optional in the component and conditionally render them. Clearing the page data alone leaves empty tags and awkward spacing.
